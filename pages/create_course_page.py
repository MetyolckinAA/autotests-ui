...
class CreateCoursePage(BasePage):
    ...
    def check_visibility_create_course_title(self):
    ...
    def check_visibility_image_upload_view(self, is_image_uploaded: bool = False):
    ...
    def check_visibility_create_exercise_form(self, index: int, title: str, description: str):
